...
import Image from 'next/image'; // <-- PERBAIKAN 1: Impor komponen Image
                ...
                <div className="p-1">
                  <div className="relative pt-10 mb-8">
                    <Card className="bg-white rounded-2xl shadow-lg p-6 pt-16">
                      <CardContent className="p-0">
                        {/* Avatar */}
                        {/* Parent div sudah memiliki w-20 h-20, 'relative' ditambahkan */}
                        <div className=" -top-10 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg relative">
                        ...
                        <div className="space-y-4">
                          ...
                          {/* PERBAIKAN 3: Ganti " dengan &ldquo; dan &rdquo; */}
                          <p className="text-gray-900 font-semibold text-center">
