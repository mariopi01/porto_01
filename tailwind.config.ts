...
import tailwindcssAnimate from "tailwindcss-animate" // 1. Impor plugin v3

const config = {
  darkMode: "class", // Ini benar
  content: [
    './pages/**/*.{ts,tsx}',
    './components/**/*.{ts,tsx}',
    './app/**/*.{ts,tsx}',
  ...
  theme: {
    ...
    extend: {
      // 2. Tentukan font kustom Anda
      fontFamily: {
        sans: ["var(--font-raleway)", ...defaultTheme.fontFamily.sans], 
        heading: ["var(--font-mulish)", ...defaultTheme.fontFamily.sans],
      },
      // 3. Warna kustom Anda + warna ShadCN v3
      colors: {
        primary: '#3b82f6', 
        secondary: '#60a5fa', 
        darkBg: '#1f2937', 
        ...
        background: "hsl(var(--background))",
        foreground: "hsl(var(--foreground))",
        // ... (warna shadcn lainnya akan berfungsi dengan CSS vars di atas)
      },
      // 4. KEMBALIKAN SEMUA KEYFRAME & ANIMASI (Sangat Penting)
      // Ini diambil dari proyek Vite asli Anda
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in-up": "fade-in-up 0.6s ease-out",
